...
const DICT = {
  en: {
    ...
    'help.card.battle.hint': '2 the matchup happened, 2 the winner, 2 the score.',
    'help.gap.title': 'Placing gap',
    'help.gap.exact': 'Exact',
    'help.gap.beyond': 'Beyond',
    'help.matchup.short': 'Put Alem against NaPoM in the semi-final and they meet in the quarter-final instead? You still score. A matchup is judged on the pair, not on where it sits in the bracket.',
  ...
  fr: {
    ...
    'help.card.battle.hint': '2 l’affiche a eu lieu, 2 le vainqueur, 2 le score.',
    'help.gap.title': 'Écart de placement',
    'help.gap.exact': 'Exact',
    'help.gap.beyond': 'Au-delà',
    'help.matchup.short': 'Vous opposez Alem à NaPoM en demi-finale et ils se croisent en quart ? Vous marquez quand même. Une affiche se juge sur la paire, pas sur sa place dans le tableau.',

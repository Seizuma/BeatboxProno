...
const DICT = {
  en: {
    ...
    'help.rank.qualified.detail': 'One point per artist who really qualified AND whom you had in the qualifying spots',
    ...
    'help.qualify.title': 'Qualification points have a ceiling',
    'help.qualify.body': 'Only the artists who actually go through are worth a qualification point — never the whole field. On a phase where 20 compete and 8 go through, at most 8 of these points are on the table. And a phase that eliminates nobody hands out none at all: there is nothing to read.',
  ...
  fr: {
    ...
    'help.rank.qualified.detail': 'Un point par artiste réellement qualifié ET que vous aviez placé dans les places qualificatives',
    ...
    'help.qualify.title': 'Les points de qualification sont plafonnés',
    'help.qualify.body': 'Seuls les artistes qui passent réellement valent un point de qualification — jamais tout le plateau. Sur une phase où 20 concourent et 8 passent, il y a au plus 8 de ces points en jeu. Et une phase qui n’élimine personne n’en distribue aucun : il n’y a rien à lire.',

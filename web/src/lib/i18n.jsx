...
const DICT = {
  en: {
    ...
    'event.saving': 'Saving…',
    'draft.title': 'Your versions',
    'draft.none': 'No version yet on this category.',
    'draft.start': 'Start a prediction',
    'draft.new': 'New',
    'draft.duplicate': 'Duplicate',
    'draft.rename': 'Rename',
    'draft.rename.ok': 'Rename',
    'draft.cancel': 'Cancel',
    'draft.delete': 'Delete',
    'draft.withdraw': 'Back to draft',
    'draft.submitted': 'filed prediction',
    'draft.untitled': 'Untitled',
    'draft.cap': 'You have reached {max} drafts. Delete one to open another.',
    'draft.created': '{name} created.',
    'draft.renamed': 'Renamed.',
    'draft.deleted': 'Draft deleted.',
    'draft.withdrawn': 'Back to draft — nothing is filed for this category now.',
    'event.already.submitted': 'Filed ★',
  },
  ...
  fr: {
    ...
    'draft.title': 'Vos versions',
    'draft.none': 'Aucune version sur cette catégorie.',
    'draft.start': 'Commencer un pronostic',
    'draft.new': 'Nouveau',
    'draft.duplicate': 'Dupliquer',
    'draft.rename': 'Renommer',
    'draft.rename.ok': 'Renommer',
    'draft.cancel': 'Annuler',
    'draft.delete': 'Supprimer',
    'draft.withdraw': 'Remettre en brouillon',
    'draft.submitted': 'pronostic déposé',
    'draft.untitled': 'Sans titre',
    'draft.cap': 'Vous avez atteint {max} brouillons. Supprimez-en un pour en ouvrir un autre.',
    'draft.created': '{name} créée.',
    'draft.renamed': 'Renommée.',
    'draft.deleted': 'Brouillon supprimé.',
    'draft.withdrawn': 'Remis en brouillon — plus rien n’est déposé sur cette catégorie.',
    'event.already.submitted': 'Déposé ★',
  },
};

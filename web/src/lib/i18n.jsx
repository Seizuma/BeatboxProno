...
const DICT = {
  en: {
    ...
    'event.podium.eyebrow': '14 points on the table',
    'event.podium.title': 'Final top 4',
    'event.podium.lede': '5 points for first place, then 4, 3 and 2.',
    'event.podium.value': 'worth {n} points',
    'event.podium.empty': 'No pick',
    ...
    'stats.favourites.lede': 'Picked first in the final top 4, all predictions combined.',
  ...
  fr: {
    ...
    'event.podium.eyebrow': '14 points en jeu',
    'event.podium.title': 'Top 4 final',
    'event.podium.lede': '5 points pour la première place, puis 4, 3 et 2.',
    'event.podium.value': 'vaut {n} points',
    'event.podium.empty': 'Aucun choix',
    ...
    'stats.favourites.lede': 'Donnés premiers du top 4 final, tous pronostics confondus.',

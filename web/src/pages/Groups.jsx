 ...
 * ensuite ici.
 *
 * La disposition suit celle de la fiche de groupe — ligne de service à deux
 * étages, vignettes barrées de la couleur du cercle. Le formulaire de création
 * occupe une bande horizontale plutôt qu'une colonne de champs empilés : trois
 * blocs les uns sous les autres dans une colonne étroite donnaient une page
 * qui s'entasse, avec des champs plus courts que leurs propres exemples.
 */
                ...
                <div className="stack" style={{ marginTop: '1.4rem' }}>
                    ...
                    <section className="panel stack" style={{ gap: '0.8rem' }}>
                        ...
                        {atLimit ? (
                            ...
                            <form className="newgroup" onSubmit={create}>
                                <div className="field">

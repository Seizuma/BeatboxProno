...
export const ITEMS = [
    ...
    { id: 'frame-rivets', slot: 'frame', price: 45, css: 'cos-f-rivets',
    ...
    { id: 'frame-vis', slot: 'frame', price: 70, css: 'cos-f-vis',
    ...
    /* --- Bandes de profil -------------------------------------------------- */
    { id: 'band-faders', slot: 'band', price: 60, art: 'faders',
      name: { en: 'Faders', fr: 'Faders' } },
    { id: 'band-skyline', slot: 'band', price: 70, art: 'skyline',
    ...
    { id: 'band-tape', slot: 'band', price: 50, art: 'tape',
      name: { en: 'Magnetic tape', fr: 'Bande magnétique' } },
    { id: 'band-cities', slot: 'band', price: 110, art: 'cities',
    ...
    { id: 'stamp-turning', slot: 'stamp', price: 50, color: 'o',
      text: { en: 'IT TURNS HERE', fr: 'ICI ÇA BASCULE' }, name: { en: 'It turns here', fr: 'Ici ça bascule' } },
    { id: 'stamp-favourite', slot: 'stamp', price: 35, color: 'm',
      text: { en: 'MY PICK', fr: 'MON CHOUCHOU' }, name: { en: 'My pick', fr: 'Mon chouchou' } },
    { id: 'stamp-confirmed', slot: 'stamp', price: 75, color: 'y', requiresBadge: 'PODIUM_1',
    ...
    { id: 'stamp-tv', slot: 'stamp', price: 45, color: 'c',

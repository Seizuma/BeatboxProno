...
export const ITEMS = [
    ...
    { id: 'frame-equerres', slot: 'frame', price: 150, css: 'cos-f-equerres',
      name: { en: 'Corner brackets', fr: 'Équerres' } },
    { id: 'frame-grille', slot: 'frame', price: 200, css: 'cos-f-grille',
    ...
    { id: 'frame-pellicule', slot: 'frame', price: 150, css: 'cos-f-pellicule',
      name: { en: 'Processor', fr: 'Processeur' } },
    { id: 'frame-chevrons', slot: 'frame', price: 200, css: 'cos-f-chevrons',
      name: { en: 'Chevrons', fr: 'Chevrons' } },
    { id: 'frame-double', slot: 'frame', price: 150, css: 'cos-f-double',
      name: { en: 'Double rule', fr: 'Double filet' } },
    { id: 'frame-ruban', slot: 'frame', price: 150, css: 'cos-f-ruban',
      name: { en: 'Torn tape', fr: 'Ruban' } },
    { id: 'frame-cube', slot: 'frame', price: 200, css: 'cos-f-cube',
      name: { en: 'Cube shards', fr: 'Éclats de cube' } },
    { id: 'frame-tricolore', slot: 'frame', price: 150, css: 'cos-f-tricolore',
      name: { en: 'Tricolour', fr: 'Tricolore' } },
    { id: 'frame-cypher', slot: 'frame', price: 150, css: 'cos-f-cypher',
      name: { en: 'Cypher', fr: 'Cypher' } },
    { id: 'frame-coeurs', slot: 'frame', price: 200, css: 'cos-f-coeurs',
      name: { en: 'Hearts', fr: 'Cœurs' } },
    { id: 'frame-fleurs', slot: 'frame', price: 200, css: 'cos-f-fleurs',
      name: { en: 'Flowers', fr: 'Fleurs' } },
    { id: 'frame-cabine', slot: 'frame', price: 150, css: 'cos-f-cabine',
      name: { en: 'Booth', fr: 'Cabine' } },

    // Par crans : de l'animation image par image, dessinée.
    { id: 'frame-course', slot: 'frame', price: 300, css: 'cos-f-course', animated: true,
      name: { en: 'Running light', fr: 'Lampe qui court' } },
    { id: 'frame-rgb', slot: 'frame', price: 500, css: 'cos-f-rgb', animated: true,
      name: { en: 'RGB', fr: 'RGB' } },
    { id: 'frame-rec', slot: 'frame', price: 400, css: 'cos-f-rec', animated: true,
      name: { en: 'Rec light', fr: 'Voyant REC' } },

    // Fluides : deux dessins qui se fondent, ou une respiration.
    { id: 'frame-braise', slot: 'frame', price: 300, css: 'cos-f-braise', animated: true,
      name: { en: 'Embers', fr: 'Braise' } },
    { id: 'frame-relais', slot: 'frame', price: 300, css: 'cos-f-relais', animated: true,
      name: { en: 'Relay', fr: 'Relais' } },
    { id: 'frame-souffle', slot: 'frame', price: 400, css: 'cos-f-souffle', animated: true,
      name: { en: 'Breath', fr: 'Souffle' } },

    /* --- Effets de pseudo -------------------------------------------------- */
    { id: 'fx-underline', slot: 'nameFx', price: 200, css: 'cos-n-underline',
      name: { en: 'Underlined', fr: 'Souligné' } },
    { id: 'fx-chevrons', slot: 'nameFx', price: 150, css: 'cos-n-chevrons',
      name: { en: 'Chevrons', fr: 'Crochets' } },
    { id: 'fx-invert', slot: 'nameFx', price: 150, css: 'cos-n-invert',
      name: { en: 'Reverse video', fr: 'Vidéo inverse' } },
    { id: 'fx-tall', slot: 'nameFx', price: 200, css: 'cos-n-tall',
      name: { en: 'Double height', fr: 'Double hauteur' } },
    { id: 'fx-bullet', slot: 'nameFx', price: 150, css: 'cos-n-bullet',
      name: { en: 'Bullet', fr: 'Puce' } },
    { id: 'fx-spaced', slot: 'nameFx', price: 200, css: 'cos-n-spaced',
    ...
    { id: 'band-faders', slot: 'band', price: 200, art: 'vines',
      name: { en: 'Vines', fr: 'Lianes' } },
    { id: 'band-film', slot: 'band', price: 150, art: 'film',
      name: { en: 'Film strip', fr: 'Pellicule' } },
    { id: 'band-cable', slot: 'band', price: 100, art: 'cable',
      name: { en: 'Cable', fr: 'Câble' } },
    { id: 'band-blocks', slot: 'band', price: 200, art: 'blocks',
      name: { en: 'Falling blocks', fr: 'Chute de blocs' } },
    { id: 'band-missing', slot: 'band', price: 100, art: 'missing',
      name: { en: 'Missing texture', fr: 'Texture manquante' } },
    { id: 'band-curtain', slot: 'band', price: 100, art: 'curtain',
      name: { en: 'Stage curtain', fr: 'Rideau de scène' } },
    { id: 'band-vu', slot: 'band', price: 100, art: 'vu',
      name: { en: 'Vertical VU', fr: 'VU vertical' } },
    { id: 'band-flags', slot: 'band', price: 100, art: 'flags',
      name: { en: 'Flag mast', fr: 'Mât de drapeaux' } },

    /* --- Skins de carte d'export ------------------------------------------
       Les moins chers du catalogue, et c'est délibéré : chaque carte partagée
       est une affiche pour le site, vue par des gens qui n'ont pas de compte.
       Autant qu'elles soient variées plutôt que rentables. Ils restent donc
       trois à cinq fois sous le prix d'un cadre, même après le rebarèmage. */
    { id: 'skin-teletext', slot: 'cardSkin', price: 0, colors: null,
      name: { en: 'Teletext', fr: 'Télétexte' } },
    { id: 'skin-orange', slot: 'cardSkin', price: 50, colors: ['#e8531c', '#ffd66b', '#2a0d02'],
      name: { en: 'Contest orange', fr: 'Orange compète' } },
    { id: 'skin-graph', slot: 'cardSkin', price: 100, colors: ['#f2ecd8', '#2f5fa0', '#1a1a1a'],
      name: { en: 'Graph paper', fr: 'Papier millimétré' } },
    { id: 'skin-amber', slot: 'cardSkin', price: 50, colors: ['#0b0b0b', '#ffb000', '#ffd48a'],
      name: { en: 'Amber', fr: 'Ambre' } },
    { id: 'skin-negative', slot: 'cardSkin', price: 100, colors: ['#f4f4f4', '#c81414', '#141414'],
      name: { en: 'Negative', fr: 'Négatif' } },
    { id: 'skin-cyan', slot: 'cardSkin', price: 50, colors: ['#04121c', '#00e8e8', '#bfe9f2'],
      name: { en: 'Deep cyan', fr: 'Cyan profond' } },
    { id: 'skin-phosphor', slot: 'cardSkin', price: 50, colors: ['#04140a', '#3cff6a', '#a8f5bd'],
      name: { en: 'Phosphor green', fr: 'Vert phosphore' } },
    { id: 'skin-gold', slot: 'cardSkin', price: 50, colors: ['#0b0b0b', '#ffe400', '#e0cf7a'],
      name: { en: 'Solid gold', fr: 'Or massif' } },

    /* --- Tampons ----------------------------------------------------------- */
    { id: 'stamp-filed', slot: 'stamp', price: 50, color: 'g',
      text: { en: 'FILED', fr: 'DÉPOSÉ' }, name: { en: 'Filed', fr: 'Déposé' } },
    { id: 'stamp-noregret', slot: 'stamp', price: 200, color: 'r',
      text: { en: 'NO REGRETS', fr: 'SANS REGRET' }, name: { en: 'No regrets', fr: 'Sans regret' } },
    { id: 'stamp-blind', slot: 'stamp', price: 100, color: 'o',
      text: { en: 'EYES CLOSED', fr: 'YEUX FERMÉS' }, name: { en: 'Eyes closed', fr: 'Les yeux fermés' } },
    { id: 'stamp-bet', slot: 'stamp', price: 150, color: 'y',
    ...
    { id: 'stamp-hearmeout', slot: 'stamp', price: 200, color: 'c',
    ...
    { id: 'stamp-what', slot: 'stamp', price: 150, color: 'w',
      text: { en: '???', fr: '???' }, name: { en: '???', fr: '???' } },
    { id: 'stamp-confirmed', slot: 'stamp', price: 100, color: 'm', requiresBadge: 'PODIUM_1',
